...
import classes from "./relativeMneuAll.module.scss";

export default function RelativeMenuAll() {
    ...
    return (
        <div className={classes.relativeMenu}>
            ...
            <div className={classes.containerFilter}>
                <p className={classes.textFilter}>הצג שכונות רייקות</p>
                <div className={classes.clickFilter} onClick={() => {
                    showEmptyClick(toSearch)
                }}>
                    <div className={classes[`pointFilter${toSearch['isToShowEmptyShchunot']}`]}></div>
                </div>
